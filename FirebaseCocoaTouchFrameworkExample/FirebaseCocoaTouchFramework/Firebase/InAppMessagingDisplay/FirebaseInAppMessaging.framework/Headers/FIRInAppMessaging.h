 ...
 *   1 Set FirebaseInAppMessagingAutomaticDataCollectionEnabled to be false in app's plist file.
 *   2 Dynamically turn on/off data collection behavior by setting automaticDataCollectionEnabled
 *     property on FIRInAppMessaging instance to be true/false.
 *   3 Global Firebase data collection setting.
 **/
FIR_SWIFT_NAME(InAppMessaging)
